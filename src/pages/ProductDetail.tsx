    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/produtos" className="text-blue-500 hover:underline">
        ...
        <div className="bg-gray-900 rounded-lg overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                ...
                <div className="mb-8">
                  <h2 className="text-xl font-semibold mb-3 text-gray-300">Descrição</h2>
          ...
          {product.images && product.images.length > 1 && (
            <div className="p-8 border-t border-gray-800">
              <h2 className="text-xl font-semibold mb-4">Mais imagens</h2>
              <div className="grid grid-cols-3 gap-4">
                {product.images.slice(1).map((image, index) => (
                  <div key={`${product.id}-image-${index + 1}`} className="aspect-square bg-gray-800 rounded-lg overflow-hidden">
                    <img
                      src={image}
